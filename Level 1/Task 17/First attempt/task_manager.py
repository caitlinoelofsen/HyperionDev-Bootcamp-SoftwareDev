        ...
        if username in user_login_details:
            while True:
                ...
                if password == user_login_details[username]:
                    ...
                    return True, username  # Capture username  
                else:
                    print("Incorrect password! Please try again.")
        else: 
            print("Incorrect username. Please try again.")

def register_user():  # Allow only admin user to register new users
...
def add_task():  # Allow user to create and assign tasks
    ...
    name_of_asignee = input("Enter employee name: ")
...
def view_my_tasks():  # Allow user to view specific user tasks
    username = input('Enter your username: ')
    found = False

    # Set username pattern to locate specific user's task in text file
    username_pattern = f'Assigned to: {username}'
    print("\nYour Assigned Tasks:\n")
    try:
        with open('tasks.txt', 'r') as task_file:
...
def admin_menu():  # Present the admin menu
    while True:
...
def user_menu():  # Present the user menu 
    while True: 
